...
namespace Quiz2Selenium
{
    public class Placeorder : BasePage
    {
        ...
        public void placeordr(String str_name, String str_mail, String str_pass, String str_dropvalue, String str_dropvaluemo, String str_years, String firstname, String lastname, String companyname, String adress, String county, String str_state, String citty, String zipcode, String phno, String cmnt, String carda, String cardnum, String cvc1, string exp1, String yera)
        {
            Click(addpro);
            Click(addcartt);
            Thread.Sleep(5000);
